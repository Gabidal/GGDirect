...
# ----------------------------------------------------------------------------
# Initializes and builds the GGDirect project locally. Ensures the script is run
...
check_directory() {
    ...
    local project_root_name="GGDirect"
    ...
    if [ -z "$project_root" ]; then
        echo "Error: Unable to determine the project root directory. Ensure you're in the GGDirect project."
        exit 1
    fi
